...
export default function CoupleSection() {
  return (
    <section className="relative py-16 px-4 max-w-5xl mx-auto overflow-hidden text-[#fbf8f2]">
      {/* Quran Quote Card with Oval Lace Border (as seen in video reference) */}
      <div className="reveal mb-16">
        <OvalLaceBorder>
          <div className="text-center space-y-4 py-4">
            <p className="text-2xl font-serif text-[#ebd397]">
              بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
            </p>
            <p className="text-xs uppercase tracking-[0.25em] text-[#dfbf74] font-semibold">
              Maha Suci Allah SWT
            </p>
            <blockquote className="text-xs sm:text-sm font-serif italic text-slate-100 leading-relaxed max-w-md mx-auto">
            ...
            <cite className="block text-xs font-semibold text-[#ebd397] not-italic tracking-widest uppercase pt-2">
              — QS. Ar-Rum: 21
            </cite>
          </div>
        </OvalLaceBorder>
      ...
      <div className="reveal text-center max-w-2xl mx-auto mb-16 space-y-3">
        <p className="text-xs sm:text-sm font-light text-stone-300 leading-relaxed px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-14 items-center">
        ...
        <div className="reveal-left space-y-6 text-center">
          <BurgundyCardFrame className="max-w-sm mx-auto">
            <div className="relative w-64 h-80 sm:w-72 sm:h-96 mx-auto rounded-t-full rounded-b-2xl overflow-hidden shadow-2xl border-4 border-[#dfbf74]/70">
              <Image
          ...
          <div className="space-y-2">
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#ebd397] drop-shadow">
