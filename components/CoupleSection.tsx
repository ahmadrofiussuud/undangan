...
export default function CoupleSection() {
  return (
    <section className="relative py-16 px-4 max-w-5xl mx-auto overflow-hidden text-[#fbf8f2]">
      {/* Hanging Floral Header */}
      <div className="relative w-full h-36 sm:h-48 mb-8 -mt-6">
        <Image
          src="/floral_swag.jpg"
          alt="Lush Floral Header"
          fill
          sizes="100vw"
          className="object-cover object-top filter drop-shadow-2xl brightness-110 rounded-b-3xl"
        />
      </div>

      {/* Quran Quote Card with Oval Lace Border & Hanging Tassel */}
